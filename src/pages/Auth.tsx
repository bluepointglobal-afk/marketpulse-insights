      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            {mode === "signup"
              ? "Start validating your product ideas with Bayesian science"
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center gradient-bg p-12">
        <div className="max-w-md text-primary-foreground">
          ...
          <h2 className="text-3xl font-bold mb-4">
            Mathematically defensible market validation
          </h2>
          <p className="text-primary-foreground/80 mb-8">
            Our Bayesian engine processes thousands of data points to give you investor-grade 
            market insights in seconds, not weeks.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>PSM scores with confidence intervals</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-primary-foreground/20 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>MaxDiff feature analysis</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-primary-foreground/20 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>Van Westendorp pricing</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-primary-foreground/20 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
